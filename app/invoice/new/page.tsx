...
// Gera opcoes de mes de referencia: 12 ultimos + atual + 3 futuros (16 total).
// Formato value: YYYY-MM (alinhado com o filtro do dashboard e com `reference_month` no banco).
